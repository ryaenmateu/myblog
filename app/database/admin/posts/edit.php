  ...
  <?php include(ROOT_PATH."/app/database/includes/adminSidebar.php");?>
      ...
      <div class="admin-content">
       ...
       <div class="content">
        ...
        <input type="hidden" name="id"  value="<?php echo $id;?>"id="" class=text-input>
        <div>
            <label>Title</label>
         ...
         <div>
          ...
          <div>
            <label>Image</label>
            <input type="file" name="image" value="<?php echo $image_name;?>" id="" class=text-input>
          </div>
            <div>
              <label >Topic</label>
        ...
        <div>
          <button type="submit" name="update-post" class="btn btn-big">Update Posts</button>
        </div>
        </form>
       </div>
      </div>
